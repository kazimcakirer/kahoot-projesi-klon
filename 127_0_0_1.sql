...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 29 Kas 2018, 08:08:39
...
-- Veritabanı: `online`
--
CREATE DATABASE IF NOT EXISTS `online` DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci;
USE `online`;
...
CREATE TABLE `login` (
  ...
  `PIN` varchar(8) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `login` (`ID`, `NAME`, `PIN`, `DATE`) VALUES
(1, 'KAZIM', '11111111', '2018-11-29 09:42:04');
...
('root', '2018-11-29 07:08:31', '{\"lang\":\"tr\",\"Console\\/Mode\":\"collapse\"}');
